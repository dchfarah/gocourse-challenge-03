...
import (
	...
	"github.com/dchfarah/gocourse-challenge-03/configs"
	"github.com/dchfarah/gocourse-challenge-03/internal/event/handler"
	...
	"github.com/dchfarah/gocourse-challenge-03/internal/infra/grpc/service"
...
func main() {
	...
	webserver.AddHandler(http.MethodGet, "/order", webListOrdersHandler.List)
